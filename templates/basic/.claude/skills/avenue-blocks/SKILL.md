---
name: avenue-blocks
description: Discover, evaluate, install, and verify Avenue blocks in the basic starter using `blocks.json` aliases and CLI workflows.
---
...
npx @avenuejs/cli@latest view <block>
npx @avenuejs/cli@latest add <block>
npx @avenuejs/cli@latest diff <block>
```
