# Avenue Marketplace Project

**This is a Avenue marketplace project — an open-source AI-native multi-vendor marketplace built on MedusaJS v2.**
...
```bash
# Add blocks from the Avenue registry
bunx @avenuejs/cli add <block-name>

# Search available blocks
bunx @avenuejs/cli search -q "commission"

# Generate TypeScript types from API routes
bunx @avenuejs/cli codegen
...
Avenue uses reusable blocks installed into your project:
...
```bash
bunx @avenuejs/cli add seller commission payout
```
