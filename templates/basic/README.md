# Avenue Basic Template

This template comes configured with the bare minimum to get started building your marketplace with Avenue.
...
```
DATABASE_URL=postgres://user:password@localhost:5432/avenue
...
│       └── medusa-config.ts
├── blocks.json         # Avenue blocks configuration
├── package.json
└── turbo.json
```
...
The Avenue basic template is built on top of [Medusa](https://medusajs.com) and is pre-configured for marketplace functionality.
...
You can extend your project with pre-built blocks using the Avenue CLI:
...
If you have any issues or questions start a [GitHub discussion](https://github.com/avenuejs/avenue/discussions).
