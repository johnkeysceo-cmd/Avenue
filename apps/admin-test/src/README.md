...
A custom page lets you add new views to the vendor portal. Pages are automatically discovered using file-based routing powered by the `@avenuejs/dashboard-sdk` Vite plugin.

> Learn more about the dashboard SDK in the [Avenue documentation](https://docs.avenuejs.com).
