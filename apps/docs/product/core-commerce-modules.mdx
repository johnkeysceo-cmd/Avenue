...
description: "Learn how Avenue builds on Medusa’s core commerce modules"
---

# Core commerce modules

Avenue is built on top of **Medusa’s core commerce modules**.\
These modules provide the foundational commerce primitives used in every Avenue marketplace: products, pricing, carts, orders, customers, payments, fulfillment, inventory, and more.

Avenue does **not replace** these modules.\
...
<Card title="Cart Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/cart" cta="Learn more from the Medusa docs">
  Manages carts, line items, promotions, and total calculations. Used by Avenue for multi-vendor cart orchestration.
</Card>
...
<Card title="Fulfillment Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/fulfillment" cta="Learn more from the Medusa docs">
  Handles fulfillment providers and shipping. Avenue extends it with vendor-level fulfillment flows.
</Card>
...
<Card title="Order Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/order" cta="Learn more from the Medusa docs">
  Manages orders, statuses, and returns. Avenue extends it with multi-seller order splitting logic.
</Card>
...
<Card title="Payment Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/payment" cta="Learn more from the Medusa docs">
  Integrates payment providers and transaction flows. Used by Avenue for multi-vendor payments and payouts.
</Card>
...
<Card title="Product Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/product" cta="Learn more from the Medusa docs">
  Defines products, variants, options, and collections. Avenue adds seller ownership, moderation, and request flows.
</Card>
...
<Card title="User Module" horizontal href="https://docs.medusajs.com/resources/commerce-modules/user" cta="Learn more from the Medusa docs">
  Handles internal user accounts. Avenue extends this with vendor roles and permissions.
</Card>

---

By keeping all Medusa modules intact and fully accessible, Avenue ensures developers retain complete control over both the **commerce layer** and the **marketplace domain layer**.
