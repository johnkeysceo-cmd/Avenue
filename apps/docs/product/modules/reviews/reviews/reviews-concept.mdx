...
You can build custom workflows and steps. Avenue provides pre-built workflows for review operations in the `@avenuejs/reviews` package.
...
import { AlgoliaEvents, CreateReviewDTO } from "@avenuejs/framework"
...
In this document, you'll learn about the main concepts related to reviews in Avenue.
