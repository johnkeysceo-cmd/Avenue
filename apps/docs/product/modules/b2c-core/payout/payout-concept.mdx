...
You can build custom workflows and steps. Avenue provides pre-built workflows for payout operations in the `@avenuejs/b2c-core` package.
...
In this document, you'll learn about the main concepts related to payouts in Avenue.
...
Avenue uses webhooks from payment providers to handle asynchronous payout events:
