...
Secondary categories are managed through workflow hooks on Medusa's core `updateProductsWorkflow`. Avenue extends this workflow to handle secondary category assignments:
...
In this document, you'll learn about the main concepts related to secondary categories in Avenue.
...
Avenue's Secondary Category Module provides an **additional layer** of categorization:
