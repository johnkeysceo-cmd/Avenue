...
You can build custom workflows and steps. Avenue provides pre-built workflows for common attribute operations in the `@avenuejs/b2c-core` package.
...
In this document, you'll learn about the main concepts related to attributes in Avenue.
