...
You can build custom workflows and steps. Avenue provides pre-built workflows for seller operations in the `@avenuejs/b2c-core` package.
...
import { CreateMemberDTO, CreateSellerDTO } from "@avenuejs/framework"
import {
  createMemberStep,
...
In this document, you'll learn about the main concepts related to sellers in Avenue.
