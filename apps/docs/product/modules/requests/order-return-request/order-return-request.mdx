...
You can build custom workflows and steps. Avenue provides pre-built workflows for return request operations in the `@avenuejs/requests` package.
...
import { CreateOrderReturnRequestDTO } from "@avenuejs/framework"
import { ORDER_RETURN_MODULE } from "../../../modules/order-return-request"
import { SELLER_MODULE } from "@avenuejs/framework"
import {
...
In this document, you'll learn about the main concepts related to order return requests in Avenue.
