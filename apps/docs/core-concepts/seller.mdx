...
Avenue comes with a `Seller` module that allows you to manage seller products, team members, orders, stock locations and shipping options.
...
In Avenue, the `Seller` is the entity that represents member group in the marketplace.
