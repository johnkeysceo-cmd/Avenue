...
description: "Modular blocks from the official Avenue registry — install only what you need."
mode: "custom"
---
...
<div className="max-w-5xl mx-auto px-6 py-16">
  ...
  <div className="mb-12">
    ...
    <div className="inline-flex items-center gap-3 px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
      <code className="text-sm font-mono text-gray-800 dark:text-gray-100">bunx @avenuejs/cli@latest add &lt;block-name&gt;</code>
    </div>
  </div>
  ...
  <div className="mt-10 p-5 rounded-xl border border-gray-200 dark:border-gray-800">
    <p className="text-sm text-gray-500 dark:text-gray-400 m-0">
      Blocks are copied directly into your project — no runtime dependencies on Avenue.
...
```bash
bunx @avenuejs/cli@latest search -q "reviews"
```
