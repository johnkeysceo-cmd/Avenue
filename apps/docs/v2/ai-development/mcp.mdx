---
title: "MCP Server"
description: "Connect your AI environment to Avenue documentation via Model Context Protocol."
---

# MCP Server

Avenue exposes a [Model Context Protocol](https://modelcontextprotocol.io) (MCP) server that lets AI tools **search Avenue documentation directly**. Instead of relying on training data that may be outdated, your AI assistant queries the actual docs in real time.
...
Searches across all Avenue documentation and returns:
...
<Tabs>
  <Tab title="Cursor">
    <Steps>
      ...
      <Step title="Use it">
        Restart Cursor and ask: **"Search Avenue docs for how to add a block"**
      </Step>
    </Steps>
    ...
    <Steps>
      ...
      <Step title="Configure the server">
        ```json
        {
          "mcpServers": {
            "avenue": {
              "serverUrl": "https://docs.avenuejs.com/mcp"
            }
          }
        }
        ```
      ...
      <Step title="Use it">
        Open Cascade and ask: **"Search Avenue docs for seller setup"**
      </Step>
    </Steps>
  </Tab>
  <Tab title="Claude">
  ...
  <Tab title="Claude Code">
    <Steps>
      ...
      <Step title="Use it">
        Claude Code can now query Avenue documentation directly during any conversation.
      </Step>
    </Steps>
