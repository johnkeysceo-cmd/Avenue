---
title: "Commission"
description: "How marketplace commissions work in Avenue — rates, rules, calculation, and the commission pipeline."
---

Commissions are how the marketplace earns revenue. Rather than storing a single commission percentage, Avenue uses a **rule-based system** where commission rates are matched to line items and shipping methods based on configurable conditions.
