---
title: "Installation"
description: "Install Avenue and set up your marketplace project."
---
...
<Tip>
  ...
  ```bash
  docker run -d --name avenue-postgres \
...
```bash
bunx @avenuejs/cli@latest create
```
...
If you have an existing Medusa project, initialize Avenue in it:
...
```bash
bunx @avenuejs/cli@latest add <block-name>
```
