...
module.exports = defineConfig({
  ...
  modules: [
    {
      resolve: "@avenuejs/core-plugin/modules/custom-fields",
      options: {
        customFields: {
          Product: {
...
const customFieldsService = container.resolve(AvenueModules.CUSTOM_FIELDS);
...
} from "@avenuejs/core-plugin/workflows";
```
