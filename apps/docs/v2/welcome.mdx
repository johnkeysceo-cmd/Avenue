...
<div className="max-w-5xl mx-auto px-6 py-16">
  <div className="text-center mt-12 mb-16">
    <h1 className="text-5xl font-bold tracking-tight mb-4">Avenue v2.0 is here</h1>
    <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
      Most tools use AI to generate snippets. Avenue lets AI work at the system level — composing APIs, modifying workflows, extending UI, and evolving your marketplace architecture.
    </p>
    <div className="mt-8 flex gap-4 justify-center">
      ...
      <a href="https://github.com/avenuejs/avenue/releases/tag/v2.0.0" className="inline-flex items-center px-5 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 font-medium text-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors no-underline">
        Release Notes
      </a>
    </div>
  </div>
  ...
  <div className="mb-16">
    ...
    <p className="text-gray-500 dark:text-gray-400 mb-6">Avenue 2.0 provides clear, predictable patterns that AI can reason about.</p>
  ...
  <div className="mb-16">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <a href="https://github.com/avenuejs/avenue" className="block p-5 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition-all no-underline">
      ...
      <a href="/v2/ai-development/llms" className="block p-5 rounded-xl border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition-all no-underline">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 m-0">LLMs, MCP server, and skills — connect your AI tools to Avenue.</p>
      </a>
    </div>
  </div>
</div>
