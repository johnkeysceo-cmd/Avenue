...
Avenue uses <a href="https://stripe.com">Stripe</a> as the default payment and payout provider. The integration enables secure payment processing, automatic payouts to sellers, and commission handling for marketplace transactions.

### Setup

To use Stripe with Avenue, you'll need to:
