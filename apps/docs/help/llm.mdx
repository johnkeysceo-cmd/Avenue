---
title: "LLM"
description: "How Avenue documentation is optimized for LLMs."
---

# LLM

Avenue’s documentation is optimized to be easily indexed and understood by Large Language Models (LLMs).\
\
This helps AI tools answer technical questions about Avenue more accurately by giving them a clear map of the documentation structure.
