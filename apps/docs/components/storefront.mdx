...
Our B2C Marketplace Storefront implementation is a powerful, customizable storefront designed for B2C marketplaces, built to work perfectly with other AvenueJS components.

<Info>
  Check our implementation of Storefront:
  <a href="https://github.com/avenuejs/b2c-marketplace-storefront">Github</a>
</Info>
...
## Technical Integration with Avenue

The storefront is built as part of the Avenue ecosystem, which provides:

1. **Backend Integration**

   - Seamless integration with Avenue's backend services
