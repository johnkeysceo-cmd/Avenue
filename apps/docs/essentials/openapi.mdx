...
Avenue uses OpenAPI to define the API endpoints, request and response schemas. You can use **http-client** package which is already defined in the project to generate types and a fetch client:
...
import { vendorCreateSeller } from "@avenuejs/http-client";
// Import the generated types
import {
  VendorCreateSeller,
  VendorCreateSeller201,
} from "@avenuejs/http-client/types";
