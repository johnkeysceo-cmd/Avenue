---
title: "Core Events"
description: "Events emitted by the Core Avenue Module workflows"
---
...
- [cancelOrderWorkflow](https://docs.avenuejs.com/docs/product/workflows/core/order-workflows)
...
- [splitAndCompleteCartWorkflow](https://docs.avenuejs.com/docs/product/workflows/core/cart-workflows)
...
- [processPayoutForOrderWorkflow](https://docs.avenuejs.com/docs/product/workflows/core/payout-workflows)
...
- [updateSellerWorkflow](https://docs.avenuejs.com/docs/product/workflows/core/seller-workflows)
...
- [importSellerProductsWorkflow](https://docs.avenuejs.com/docs/product/workflows/core/seller-workflows)
