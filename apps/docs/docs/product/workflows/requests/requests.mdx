...
This documentation provides a reference to the `acceptProductCategoryRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-product-category-request.ts)
...
This documentation provides a reference to the `acceptProductCollectionRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-product-collection-request.ts)
...
This documentation provides a reference to the `acceptProductRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-product-request.ts)
...
This documentation provides a reference to the `acceptProductTagRequestWorkflow`. It belongs to the `@avenuejs/requests` package.

This workflow accepts a product tag creation request by creating the tag and updating the request status to "accepted".

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-product-tag-request.ts)
...
This documentation provides a reference to the `acceptProductTypeRequestWorkflow`. It belongs to the `@avenuejs/requests` package.

This workflow accepts a product type creation request by creating the type and updating the request status to "accepted".

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-product-type-request.ts)
...
This documentation provides a reference to the `acceptReviewRemoveRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-review-remove-request.ts)
...
This documentation provides a reference to the `acceptSellerCreationRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/accept-seller-creation-request.ts)
...
This documentation provides a reference to the `createProductRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/create-product-request.ts)
...
This documentation provides a reference to the `createProductUpdateRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/create-product-update-request.ts)
...
This documentation provides a reference to the `createRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/create-request.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { fetchSellerByAuthActorId } from "@avenuejs/framework";
...
This documentation provides a reference to the `createSellerCreationRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/create-seller-creation-request.ts)
...
<Tabs>
  <Tab title="Subscriber">
    ...
    import { SubscriberArgs, SubscriberConfig } from "@medusajs/framework";
    import { CreateRequestDTO, SellerRequest } from "@avenuejs/framework";
...
This documentation provides a reference to the `importSellerProductsRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/import-seller-products-request.ts)
...
This documentation provides a reference to the `updateRequestDataWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/update-request-data.ts)
...
This documentation provides a reference to the `updateRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/workflows/update-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/steps/create-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/steps/update-related-product-status.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/steps/update-request-data.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/requests/steps/update-request.ts)
