...
This documentation provides a reference to the `createOrderReturnRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/workflows/create-return-request.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { SELLER_ORDER_LINK } from "@avenuejs/framework";
...
This documentation provides a reference to the `proceedReturnRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/workflows/proceed-return-request.ts)
...
This documentation provides a reference to the `updateOrderReturnRequestWorkflow`. It belongs to the `@avenuejs/requests` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/workflows/update-return-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/steps/create-return-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/steps/retrieve-order-from-return-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/steps/update-return-request.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/requests/src/workflows/order-return-request/steps/validate-order-return-request.ts)
