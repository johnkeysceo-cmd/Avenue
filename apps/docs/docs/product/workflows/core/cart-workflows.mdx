...
This documentation provides a reference to the `addSellerShippingMethodToCartWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/add-seller-shipping-method-to-cart.ts)
...
This documentation provides a reference to the `deleteSellerLineItemWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/delete-seller-line-item.ts)
...
This documentation provides a reference to the `listSellerReturnShippingOptionsForOrderWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/list-seller-return-shipping-options-for-order.ts)
...
This documentation provides a reference to the `listSellerShippingOptionsForCartWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/list-seller-shipping-options-for-cart.ts)
...
This documentation provides a reference to the `removeCartShippingMethodsWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow removes specified shipping methods from a cart.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/remove-cart-shipping-method.ts)
...
This documentation provides a reference to the `splitAndCompleteCartWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/cart/workflows/split-and-complete-cart.ts)
