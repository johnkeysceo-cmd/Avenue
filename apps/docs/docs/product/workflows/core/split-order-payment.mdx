...
This documentation provides a reference to the `markSplitOrderPaymentsAsCapturedWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/workflows/mark-split-order-payments-as-captured.ts)
...
<Tabs>
  ...
  <Tab title="Order Set Placed Subscriber">
    ...
    import { OrderSetWorkflowEvents } from '@avenuejs/framework'
    import { markSplitOrderPaymentsAsCapturedWorkflow } from '../workflows/split-order-payment/workflows'
...
This documentation provides a reference to the `partialPaymentRefundWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/workflows/partial-payment-refund.ts)
...
This documentation provides a reference to the `refundSplitOrderPaymentWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/workflows/refund-split-order-payment.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/steps/create-split-order-payments.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/steps/update-split-order-payment.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/split-order-payment/steps/validate-refund-split-order-payment.ts)
