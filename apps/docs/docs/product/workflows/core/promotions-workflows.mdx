...
This documentation provides a reference to the `batchVendorPromotionRulesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/workflows/batch-vendor-promotion-rules.ts)
...
This documentation provides a reference to the `updateVendorPromotionWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates an existing promotion. It validates that any new campaign association belongs to the seller.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/workflows/update-vendor-promotion.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/steps/register-usage-step.ts)
