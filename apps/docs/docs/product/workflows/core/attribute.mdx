...
This documentation provides a reference to the `createAttributePossibleValuesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow creates one or more possible values for an attribute.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/create-attribute-possible-values.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { CreateAttributeValueDTO } from "@avenuejs/framework";
...
This documentation provides a reference to the `createAttributeValueWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/create-attribute-value.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { CreateProductAttributeValueDTO } from "@avenuejs/framework";
...
This documentation provides a reference to the `createAttributesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow creates one or more attributes and optionally links them to product categories.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/create-attributes.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { CreateAttributeDTO } from "@avenuejs/framework";
...
This documentation provides a reference to the `deleteAttributeValueWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/delete-attribute-value.ts)
...
This documentation provides a reference to the `deleteAttributeWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow deletes an attribute definition.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/delete-attribute.ts)
...
This documentation provides a reference to the `updateAttributePossibleValueWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates a possible value definition of an attribute (e.g., changing "Blue" to "Navy").

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/update-attribute-possible-value.ts)
...
<Tabs>
  <Tab title="API Route">
    ...
    import { UpdateAttributeValueDTO } from "@avenuejs/framework";
...
This documentation provides a reference to the `updateAttributesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates one or more attributes, including their details, possible values, and category associations.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/workflows/update-attributes.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/create-attribute-possible-values.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/create-attribute-value.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/create-attributes.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/delete-attribute-value.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/delete-attribute.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/update-attribute-possible-value.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/update-attributes.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/attribute/steps/validate-attribute-value.ts)
