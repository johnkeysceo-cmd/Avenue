...
This documentation provides a reference to the `createLocationFulfillmentSetAndAssociateWithSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/fulfillment-set/create-location-fulfillment-set-and-associate-with-seller.ts)
...
This documentation provides a reference to the `createVendorServiceZonesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/fulfillment-set/create-vendor-service-zone.ts)
...
This documentation provides a reference to the `deleteVendorServiceZonesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/fulfillment-set/delete-vendor-service-zone.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/common/steps/emit-multiple-events-step.ts)
