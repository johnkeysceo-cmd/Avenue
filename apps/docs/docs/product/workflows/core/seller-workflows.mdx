...
This documentation provides a reference to the `acceptMemberInvitesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/accept-member-invite.ts)
...
This documentation provides a reference to the `createOnboardingForSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/create-onboarding-for-seller.ts)
...
This documentation provides a reference to the `createPayoutAccountForSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/create-payout-account-for-seller.ts)
...
This documentation provides a reference to the `createSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/create-seller.ts)
...
This documentation provides a reference to the `createVendorPromotionWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/workflows/create-vendor-promotion.ts)
...
This documentation provides a reference to the `deleteMemberInvitesWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow deletes a member invitation.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/delete-member-invite.ts)
...
This documentation provides a reference to the `deleteMemberWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow deletes a member from a seller's team.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/delete-member.ts)
...
This documentation provides a reference to the `deleteSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow deletes a seller from the marketplace.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/delete-seller.ts)
...
This documentation provides a reference to the `exportSellerProductsWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/export-seller-products.ts)
...
This documentation provides a reference to the `importSellerProductsWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/import-seller-products.ts)
...
This documentation provides a reference to the `inviteMemberWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow creates a member invitation for a seller's team.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/invite-member.ts)
...
This documentation provides a reference to the `inviteSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow sends an invitation email to a potential seller to join the marketplace platform.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/invite-seller.ts)
...
This documentation provides a reference to the `recalculateOnboardingWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/recalculate-onboarding.ts)
...
This documentation provides a reference to the `syncStripeAccountWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/sync-stripe-account.ts)
...
This documentation provides a reference to the `updateMemberWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates a member's details.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/update-member.ts)
...
This documentation provides a reference to the `updateSellerWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates a seller's details.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/workflows/update-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-member-invites.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-member.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-payment-account.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-payout-onboarding.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-seller-onboarding.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-seller-shipping-profile.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/create-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/delete-member-invite.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/delete-member.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/delete-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/get-seller-products.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/recalculate-onboarding.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/send-invitation-email.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/sync-stripe-account.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/update-member-invite.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/update-member.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/update-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/validate-member-invites.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/validate-no-existing-payout-account-for-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/validate-payout-account-exists-for-seller.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/seller/steps/validate-products-to-import.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/steps/verify-vendor-campaign.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/steps/verify-vendor-promotion.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/promotions/steps/verify-vendor-target-promotion-rules.ts)
