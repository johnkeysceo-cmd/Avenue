...
This documentation provides a reference to the `createConfigurationRuleWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/configuration/workflows/create-configuration-rule.ts)
...
This documentation provides a reference to the `updateConfigurationRuleWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow updates an existing configuration rule, allowing administrators to enable or disable marketplace features.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/configuration/workflows/update-configuration-rule.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/configuration/steps/create-configuration-rule.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/configuration/steps/update-configuration-rule.ts)
