...
This documentation provides a reference to the `cancelOrderWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/workflows/cancel-order.ts)
...
This documentation provides a reference to the `getVendorOrdersListWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/workflows/get-vendor-order-list.ts)
...
This documentation provides a reference to the `processPayoutForOrderWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/workflows/process-payout-for-order.ts)
...
<Tabs>
  <Tab title="Subscriber">
    ...
    import { PayoutWorkflowEvents } from '@avenuejs/framework'
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/steps/calculate-payout-for-order.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/steps/calculate-total-commission.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/steps/create-payout.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/steps/validate-no-existing-payout-for-order.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/order/steps/validate-seller-payout-account.ts)
