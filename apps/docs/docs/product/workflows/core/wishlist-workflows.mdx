...
This documentation provides a reference to the `createWishlistEntryWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/wishlist/workflows/create-wishlist.ts)
...
This documentation provides a reference to the `deleteWishlistEntryWorkflow`. It belongs to the `@avenuejs/b2c-core` package.

This workflow removes a product from a customer's wishlist by dismissing the link between the wishlist and the product.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/wishlist/workflows/delete-wishlist.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/wishlist/steps/create-wishlist.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/wishlist/steps/delete-wishlist.ts)
