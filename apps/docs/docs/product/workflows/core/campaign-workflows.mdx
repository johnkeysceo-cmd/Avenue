...
This documentation provides a reference to the `createVendorCampaignWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/campaigns/workflows/create-vendor-campaign.ts)
