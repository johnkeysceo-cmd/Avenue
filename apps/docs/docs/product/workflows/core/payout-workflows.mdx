...
This documentation provides a reference to the `processPayoutWebhookActionWorkflow`. It belongs to the `@avenuejs/b2c-core` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/payout/workflows/process-payout-webhook-action.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/payout/steps/create-payout-reversal.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/b2c-core/src/workflows/payout/steps/update-payout-account.ts)
...
<Tabs>
  <Tab title="Webhook Processing">
    ...
    import { PayoutAccountStatus, PayoutWebhookAction } from "@avenuejs/framework";
