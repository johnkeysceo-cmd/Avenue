...
This documentation provides a reference to the `createReviewWorkflow`. It belongs to the `@avenuejs/reviews` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/workflows/create-review.ts)
...
This documentation provides a reference to the `deleteReviewWorkflow`. It belongs to the `@avenuejs/reviews` package.

This workflow soft deletes a review. It exposes a hook for custom extensions.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/workflows/delete-review.ts)
...
<Tabs>
  ...
  <Tab title="Subscriber">
    ...
    import { RemoveReviewRequestUpdatedEvent } from "@avenuejs/framework";
...
This documentation provides a reference to the `updateReviewWorkflow`. It belongs to the `@avenuejs/reviews` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/workflows/update-review.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/steps/create-review.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/steps/delete-review.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/steps/update-review.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/reviews/src/workflows/review/steps/validate-review.ts)
