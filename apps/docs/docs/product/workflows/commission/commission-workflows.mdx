...
This documentation provides a reference to the `calculateCommissionWorkflow`. It belongs to the `@avenuejs/commission` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/calculate-commission.ts)
...
<Tabs>
  <Tab title="Subscriber">
    ...
    import { OrderSetWorkflowEvents, SELLER_ORDER_LINK } from "@avenuejs/framework";
...
This documentation provides a reference to the `createCommissionRuleWorkflow`. It belongs to the `@avenuejs/commission` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/create-commission-rule.ts)
...
This documentation provides a reference to the `deleteCommissionRuleWorkflow`. It belongs to the `@avenuejs/commission` package.

This workflow soft deletes a commission rule. It exposes a hook for custom extensions after the rule is deleted.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/delete-commission-rule.ts)
...
This documentation provides a reference to the `listCommissionLinesWorkflow`. It belongs to the `@avenuejs/commission` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/list-commission-lines.ts)
...
This documentation provides a reference to the `listCommissionRulesWorkflow`. It belongs to the `@avenuejs/commission` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/list-commission-rules.ts)
...
This documentation provides a reference to the `listOrderCommissionLinesWorkflow`. It belongs to the `@avenuejs/commission` package.

This workflow retrieves all commission lines for a specific order and calculates the total commission amount.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/list-order-commission-lines.ts)
...
This documentation provides a reference to the `updateCommissionRuleWorkflow`. It belongs to the `@avenuejs/commission` package.

This workflow updates an existing commission rule.

[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/update-commission-rule.ts)
...
This documentation provides a reference to the `upsertDefaultCommissionRuleWorkflow`. It belongs to the `@avenuejs/commission` package.
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/workflows/upsert-default-commission-rule.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/calculate-commission-lines.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/check-for-duplicate.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/create-commission-lines.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/create-commission-rule.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/delete-commission-rule.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/find-commission-references.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/find-commission-rules.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/list-commission-lines.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/list-order-commission-lines.ts)
...
[Source code](https://github.com/avenuejs/avenue/blob/main/packages/modules/commission/src/workflows/commission/steps/update-commission-rule.ts)
