---
title: "API"
description: "Complete API reference for Medusa Core and Avenue marketplace endpoints"
---

# API Reference

The Avenue API is built on top of Medusa Commerce, combining Medusa's powerful core e-commerce APIs with custom marketplace-specific endpoints. All API routes are RESTful and support standard HTTP methods (GET, POST, PUT, DELETE) with JSON request and response formats.

## API Structure

The Avenue platform exposes three distinct API groups, each serving different user types and use cases:
...
| API Group  | Total Endpoints | Medusa Core | Avenue Marketplace |
| ---------- | --------------- | ----------- | ------------------ |
...
The Admin API provides comprehensive management capabilities for marketplace administrators. It combines all of Medusa's standard e-commerce admin functionality with Avenue's marketplace-specific features.
...
### Avenue Custom Admin Endpoints (26)

Avenue adds marketplace-specific administrative capabilities:
...
### Avenue Custom Store Endpoints (10)

Avenue adds marketplace-specific customer features:
...
The Vendor API is entirely custom to Avenue and provides a complete self-service portal for marketplace sellers. This comprehensive API enables sellers to manage every aspect of their business independently.

### Vendor API Endpoints (107)

All vendor endpoints are Avenue-specific marketplace features:
...
## Using the Avenue API

### Interactive API Reference

All 406 endpoints (263 from Medusa Core + 143 from Avenue) are documented in our interactive API reference with request examples, response schemas, and authentication details.

<Card title="Complete API Reference" icon="book-open" href="https://docs.avenuejs.com/api-reference/admin-api-keys/list-api-keys">
  Browse all endpoints with interactive documentation and test them directly in your browser.
</Card>

### JavaScript SDK

The recommended way to interact with the Avenue API is through the JavaScript SDK. The SDK provides type-safe methods, automatic authentication handling, and works seamlessly with all Avenue endpoints.

<Card title="JavaScript SDK Documentation" icon="code" href="https://docs.avenuejs.com/docs/product/js-sdk">
