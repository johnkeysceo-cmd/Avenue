...
description: "Install Avenue backend on your local machine"
---

<Info>
  There are two ways of installing Avenue: the
  <a href="/cli-installation">CLI script</a> or manual installation.
</Info>

Follow these steps to install and run Avenue backend on your operating system:
...
<Info>
  First two packages: `@avenuejs/framework` and `@avenuejs/b2c-core` are
