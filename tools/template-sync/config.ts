...
export const templateBasicRules: TemplateBasicRule[] = [
  ...
  },
  {
    ...
    targetPaths: [
      ...
      "templates/basic/.ai/skills/avenue-cli/",
      "templates/basic/.claude/skills/avenue-cli/",
      "templates/basic/.codex/skills/avenue-cli/",
    ],
    starterPolicy: "sync",
    mode: "copy",
    reviewMessage:
  ...
  },
  {
    ...
    targetPaths: [
      "templates/basic/AGENTS.md",
      "templates/basic/packages/api/AGENTS.md",
      "templates/basic/.ai/skills/avenue-blocks/",
      "templates/basic/.claude/skills/avenue-blocks/",
      "templates/basic/.codex/skills/avenue-blocks/",
    ],
    starterPolicy: "sync",
    mode: "adapt",
    reviewMessage:
