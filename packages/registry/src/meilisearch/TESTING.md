...
The Meilisearch block provides full-text product search for multi-vendor Avenue marketplaces. This document covers the test suite architecture, how to run tests, and how to extend coverage.
