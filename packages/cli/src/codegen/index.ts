...
import { DIST_DIR, defaultMedusaRoutes, defaultAvenueRoutes } from "./constants";
...
export function generateRouteTypesFile(routes: RouteInfo[], importPathFn?: (filePath: string) => string): string {
    ...
    // Second, add default Avenue routes
    for (const [route, importType] of Object.entries(defaultAvenueRoutes)) {
        routeMap.set(route, importType);
    }
    ...
    return `// This file is generated automatically by Avenue CLI
