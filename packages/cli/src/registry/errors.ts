...
export class RegistryInvalidNamespaceError extends RegistryError {
  constructor(public override readonly name: string) {
    const message = `Invalid registry namespace: "${name}". Registry names must start with @ (e.g., @avenuejs).`;
...
export class ConfigMissingError extends RegistryError {
  constructor(public readonly cwd: string) {
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Run '@avenuejs/cli init' to create an blocks.json file, or check that you're in the correct directory.",
    });
...
export class ConfigParseError extends RegistryError {
  constructor(
    ...
    super(message, {
      ...
      context: { cwd },
      suggestion:
        "Check your blocks.json file for syntax errors or invalid configuration. Run '@avenuejs/cli init' to regenerate a valid configuration.",
    });
