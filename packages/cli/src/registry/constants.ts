...
export const REGISTRY_SCHEMA_URL = "https://registry.avenuejs.com/registry.json";
export const REGISTRY_ITEM_SCHEMA_URL = "https://registry.avenuejs.com/registry-item.json";
...
export const REGISTRY_URL =
  ...
  "https://raw.githubusercontent.com/avenuejs/avenue/canary/packages/registry/r";

// Built-in registries that are always available and cannot be overridden
export const BUILTIN_REGISTRIES: z.infer<typeof registryConfigSchema> = {
  "@avenuejs": `${REGISTRY_URL}/{name}.json`,
};
