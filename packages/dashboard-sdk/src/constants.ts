...
export const CONFIG_VIRTUAL_MODULE = "virtual:avenue/config"
export const ROUTES_VIRTUAL_MODULE = "virtual:avenue/routes"
export const COMPONENTS_VIRTUAL_MODULE = "virtual:avenue/components"
export const MENU_ITEMS_VIRTUAL_MODULE = "virtual:avenue/menu-items"
export const I18N_VIRTUAL_MODULE = "virtual:avenue/i18n"
