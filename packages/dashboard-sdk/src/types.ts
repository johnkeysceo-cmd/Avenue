...
/**
 * Configuration for the Avenue dashboard plugin.
 *
 * Passed to `avenueDashboardPlugin()` in `vite.config.ts` to configure
...
export interface BuiltAvenueConfig extends AvenueConfig {
    backendUrl: string;
    base?: string;
    root: string
    srcDir: string
