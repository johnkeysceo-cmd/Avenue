...
All packages are published under the `@avenuejs` scope on npm.
...
- `@avenuejs/client`
- `@avenuejs/types`
- `@avenuejs/dashboard-sdk`
- `@avenuejs/dashboard-shared`
- `@avenuejs/core-plugin`
- `@avenuejs/vendor`
- `@avenuejs/payout-stripe-connect`

`@avenuejs/registry` is private and not published.
...
```bash
# Stable (latest)
npm install @avenuejs/cli

# Canary
npm install @avenuejs/cli@canary
```
