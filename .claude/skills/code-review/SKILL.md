---
name: code-review
description: Review code changes for contract compliance, type safety, and regression risk. Use after completing any non-trivial implementation, before merging PRs, or when asked to review code quality across any avenue package.
...
Use this skill when:
- reviewing a PR or diff across any avenue package
...
No findings. Changes are consistent with avenue patterns and contracts.
