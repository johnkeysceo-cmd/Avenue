...
This directory contains skills for Avenue development — reusable prompt modules that encode domain knowledge, checklists, and workflows.
...
```bash
cp .claude/skills/avenue-blocks/SKILL.md .cursor/rules/avenue-blocks.md
```
